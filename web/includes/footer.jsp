        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 2rem; text-align: left; margin-bottom: 2rem;">
            ...
            <div>
                ...
                <ul style="list-style: none;">
                    <li><a href="index.jsp" style="color: #ccc; text-decoration: none;">Trang chủ</a></li>
                    <li><a href="product" style="color: #ccc; text-decoration: none;">Sản phẩm</a></li>
            ...
            <div>
                ...
                <ul style="list-style: none;">
                    <li><a href="product?action=category&category=laptop" style="color: #ccc; text-decoration: none;">Balo laptop</a></li>
                    <li><a href="product?action=category&category=school" style="color: #ccc; text-decoration: none;">Balo học sinh</a></li>
                    <li><a href="product?action=category&category=travel" style="color: #ccc; text-decoration: none;">Balo du lịch</a></li>
                    <li><a href="product?action=category&category=business" style="color: #ccc; text-decoration: none;">Balo công sở</a></li>
                </ul>
            </div>
